...
def wavelength_to_color(wl, intensity):
    ...
    if wl < 440e-9:
        r = -(wl - 440e-9) / (440e-9 - 380e-9); g = 0.0; b = 1.0
    elif wl < 490e-9:
        r = 0.0; g = (wl - 440e-9) / (490e-9 - 440e-9); b = 1.0
    elif wl < 510e-9:
        r = 0.0; g = 1.0; b = -(wl - 510e-9) / (510e-9 - 490e-9)
    elif wl < 580e-9:
        r = (wl - 510e-9) / (580e-9 - 510e-9); g = 1.0; b = 0.0
    elif wl < 645e-9:
        r = 1.0; g = -(wl - 645e-9) / (645e-9 - 580e-9); b = 0.0
    else:
        r = 1.0; g = 0.0; b = 0.0
